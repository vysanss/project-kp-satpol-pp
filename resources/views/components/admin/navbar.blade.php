            ...
            <div class="hidden lg:flex items-center space-x-6 xl:space-x-8">
                ...
                <div class="relative group">
                    ...
                    <div class="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg ring-1 ring-black ring-opacity-5 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                        <div class="py-1">
                            <a href="{{ route('admin.tentangkami.index') }}" class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                                <i class="fas fa-info mr-3 text-blue-500"></i>
                                Tentang Kami
                            </a>
                            <a href="{{ route('admin.strukturorganisasi.index') }}" class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                                <i class="fas fa-sitemap mr-3 text-green-500"></i>
                                Struktur Organisasi
                            </a>
                            <a href="{{ route('admin.tupoksi.index') }}" class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                                <i class="fas fa-tasks mr-3 text-purple-500"></i>
                                Tupoksi
                            </a>
                            <a href="{{ route('admin.pelayanan.index') }}" class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                                <i class="fas fa-handshake mr-3 text-orange-500"></i>
                                Maklumat Pelayanan
                            </a>
                            <a href="{{ route('admin.profilpimpinan.index') }}" class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                ...
                <div class="relative group">
                    ...
                    <div class="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg ring-1 ring-black ring-opacity-5 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                        <div class="py-1">
                            <a href="{{ route('admin-berita') }}" class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                            ...
                            <a href="{{ route('admin-banner') }}" class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                                <i class="fas fa-image mr-3 text-green-500"></i>
                                Banner
                            </a>
                            <a href="{{ route('admin-footer') }}" class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                ...
                <!-- Layanan -->
                <a href="{{ route('admin.layanan.index') }}" class="flex items-center px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-100 transition">
...
<div id="logoutModal" class="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50 hidden">
    <div class="bg-white rounded-xl shadow-2xl p-8 max-w-sm w-full text-center">
        <div class="mb-4">
            <i class="fas fa-sign-out-alt text-red-500 text-4xl mb-2"></i>
            <h2 class="text-xl font-bold mb-2 text-gray-800">Konfirmasi Logout</h2>
            <p class="text-gray-600">Yakin mau logout?</p>
        </div>
        <div class="flex justify-center gap-4 mt-6">
            <button id="logoutYes" class="bg-red-500 hover:bg-red-600 text-white px-6 py-2 rounded-lg font-semibold shadow transition">Ya</button>
            <button id="logoutNo" class="bg-gray-200 hover:bg-gray-300 text-gray-700 px-6 py-2 rounded-lg font-semibold shadow transition">Tidak</button>
        </div>
    </div>
</div>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        logoutForms.forEach(form => {
            form.addEventListener('submit', function (e) {
                e.preventDefault();
                showLogoutModal(function (confirm) {
        ...
        logoutLinks.forEach(link => {
            link.addEventListener('click', function (e) {
                e.preventDefault();
                showLogoutModal(function (confirm) {
                    if (confirm) window.location.href = link.href;
                });
            });
        });
    });
